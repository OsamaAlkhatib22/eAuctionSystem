...
{
    public class GetFreeLancerCompletedTaskDetialsHandler
         : IRequestHandler<GetFreeLancerCompletedTaskDetialsQuery, Result<FreeLancerCompletedTaskDetialsDTO>>
    {

        private readonly DataContext _context;
        public GetFreeLancerCompletedTaskDetialsHandler(DataContext context)
        {
            _context = context;
        }
        public async Task<Result<FreeLancerCompletedTaskDetialsDTO>> Handle(
            GetFreeLancerCompletedTaskDetialsQuery request,
        ...
        )
        {
            ...
            select new FreeLancerCompletedTaskDetialsDTO
            {
            ...
            return Result<FreeLancerCompletedTaskDetialsDTO>.Success(result);
